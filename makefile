...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  buffer.o register.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#
...
#^|
buffer.o: /cygdrive/C/eclipse/workspace/test/buffer.cpp
...
#^|
buffer.o: /cygdrive/C/eclipse/workspace/test/buffer.cpp \
 /cygdrive/C/eclipse/workspace/test/buffer.h \
